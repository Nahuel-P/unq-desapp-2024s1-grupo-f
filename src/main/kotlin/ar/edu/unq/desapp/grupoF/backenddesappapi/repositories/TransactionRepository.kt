...
interface TransactionRepository: JpaRepository<Transaction, Long> {
    ...
    fun findCompletedTransactionsByUserAndBetweenDates(@Param("userId") userId: Long, @Param("startDate") startDate: LocalDateTime, @Param("endDate") endDate: LocalDateTime): List<Transaction>
}